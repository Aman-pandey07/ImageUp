...
namespace ImageUp.API.Controllers
{
        ...
        ) : ControllerBase
    {
        ...
        public async Task<IActionResult> UpdateProduct(int id, [FromForm] ProductUpdateDTO productToUpdate)
        {
            try
            {
                ...
                if (productToUpdate.ImageFile != null)
                    fileService.DeleteFileAsync(oldImage);
        ...
        public async Task<IActionResult> DeleteProduct(int id)
        {
            try
            {
                ...
                fileService.DeleteFileAsync(existingProduct.ProductImage);
        ...
        {
            var products = await productRepo.GetProductAsync();
            return Ok(products);
        }
    }
}
